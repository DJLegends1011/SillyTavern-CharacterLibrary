...
Current example:
- DataCat Yours is the account/site-backed collection in the AIO branch.
- DataCat local bookmarks use the local-backup disk icon so they are not confused with provider account favorites.
